...
const SaveButton = styled(Button)<{ themeName: string }>`
  background: ${props => props.themeName === 'dark'
    ...
    : props.themeName === 'summer'
    ? 'linear-gradient(90deg, #FF8A00 0%, #FFB800 100%)'
    : props.themeName === 'space'
    ? 'linear-gradient(90deg, #4B0082 0%, #6B48FF 100%)'
    : 'linear-gradient(90deg, #ff416c 0%, #ff4b2b 100%)'
  };
  color: white;
  padding: 16px 48px;
  ...
  &:hover {
    background: ${props => props.themeName === 'dark'
      ...
      : props.themeName === 'summer'
      ? 'linear-gradient(90deg, #FF6B6B 0%, #FF8A00 100%)'
      : props.themeName === 'space'
      ? 'linear-gradient(90deg, #6B48FF 0%, #8B48FF 100%)'
      : 'linear-gradient(90deg, #ff2b4b 0%, #ff416c 100%)'
    };
    box-shadow: ${props => props.themeName === 'dark'
      ? '0 4px 16px #0005'
